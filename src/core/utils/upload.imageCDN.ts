...
export const createFolder = async (
    ...
    try {
        ...
        throw new HttpException(400, "Upload ảnh thất bại")
    }

};

export const upload = async (files: Blob[], type: string, folder_name: string, file_name: string, source: string, order_id: string, width: string, height: string, parent_id?: string) => {
